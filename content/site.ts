...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Spearheaded the end-to-end development of six Power BI dashboards from scratch, transforming 150M+ rows of raw MySQL data through optimized views into actionable insights and collaborating with the integration team to rapidly deploy a SaaS-based Power BI Embedded API on the eSanjeevani OPD platform, an initiative of the Ministry of Health, Government of India, enhancing decision-making, customer engagement, and service quality for 300M patients till date.",
